#-*- coding:utf-8 -*-
"""作用：封装startPage页面的用户操作和状态读取。"""

from page_objects.app_ui.android.demoProject.elements.start_page_elements import StartPageElements
from page_objects.app_ui.android.demoProject.pages.index_page import IndexPage
